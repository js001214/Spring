...
public class BoardDTO {
	...
	//DTO (VO) : DB의 테이블의 각 컬럼이름을 매핑
		...
		// lombok 를 사용하면 , 어노테이션을 사용해서 getter/setter, to String, 기본생성자를 자동으로 만들어준다.
	...
	//getter/setter <== 모든 변수가 private이므로 외부에서 접근 금지된, getter/setter를 통해서 값할당.
	//Art+Shift+S
	...
	//toString() : 객체 자체를 출력 할때 객체의 메모리의 값을 출력하도록 재정의
	//기본적으로는 객체의 번지수를 출력 (hash 코트)
	@Override
